...
namespace Fundigent.Blog.Data.Migrations
{
    ...
    [Migration("20200506161035_FundigentDbSeedData2")]
    partial class FundigentDbSeedData2
    {
            ...
            modelBuilder.Entity("Fundigent.Blog.CoreObjects.Entities.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 5, 6, 12, 10, 35, 38, DateTimeKind.Local).AddTicks(3160),
                            ModifiedDate = new DateTime(2020, 5, 6, 12, 10, 35, 38, DateTimeKind.Local).AddTicks(3670),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 5, 6, 12, 10, 35, 38, DateTimeKind.Local).AddTicks(4450),
                            ModifiedDate = new DateTime(2020, 5, 6, 12, 10, 35, 38, DateTimeKind.Local).AddTicks(4480),
                            PostId = new Guid("16e9c70e-14bd-411c-ab9a-fba51f2f4610"),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 5, 6, 12, 10, 35, 38, DateTimeKind.Local).AddTicks(4500),
                            ModifiedDate = new DateTime(2020, 5, 6, 12, 10, 35, 38, DateTimeKind.Local).AddTicks(4500),
            ...
            modelBuilder.Entity("Fundigent.Blog.CoreObjects.Entities.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BlogCategory = 3,
                            CreatedDate = new DateTime(2020, 5, 6, 12, 10, 35, 21, DateTimeKind.Local).AddTicks(2640),
                            ModifiedDate = new DateTime(2020, 5, 6, 12, 10, 35, 37, DateTimeKind.Local).AddTicks(8650),
                      ...
                      and some considerations the proper design of your web API.</p> ",
                        ...
                        new
                        {
                            ...
                            BlogCategory = 3,
                            CreatedDate = new DateTime(2020, 5, 6, 12, 10, 35, 37, DateTimeKind.Local).AddTicks(9680),
                            ModifiedDate = new DateTime(2020, 5, 6, 12, 10, 35, 37, DateTimeKind.Local).AddTicks(9700),
